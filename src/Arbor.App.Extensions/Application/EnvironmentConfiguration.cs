...
namespace Arbor.App.Extensions.Application
{
    public class EnvironmentConfiguration : IConfigurationValues
    {
        ...
        [PublicAPI] public string ApplicationBasePath { get; set; }

        [PublicAPI] public string ContentBasePath { get; set; }

        [PublicAPI] public string EnvironmentName { get; set; }

        [PublicAPI] public string PublicHostname { get; set; }

        public bool UseExplicitPorts { get; set; }

        [PublicAPI] public int? PublicPort { get; set; }

        [PublicAPI] public bool? PublicPortIsHttps { get; set; }

        [PublicAPI] public int? HttpPort { get; set; }

        [PublicAPI] public int? HttpsPort { get; set; }

        [PublicAPI] public string PfxFile { get; set; }

        [PublicAPI] public string PfxPassword { get; set; }
