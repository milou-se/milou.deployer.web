    ...
    public class AllControllerActions
    {
        ...
        public void ShouldHaveExplicitHttpMethodAttribute(string controller, string assembly, string action)
        {
            ...
            foreach (MethodInfo methodInfo in actionMethod)
            {
                ...
                _testOutputHelper.WriteLine($"Controller '{controller}' with action '{action}' is missing http method attribute");
        ...
        public static IEnumerable<object[]> Data =>
            AppDomain.CurrentDomain.FilteredAssemblies(useCache: false).SelectMany(assembly => assembly.GetLoadableTypes())
